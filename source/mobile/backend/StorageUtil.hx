...
enum abstract StorageType(String) from String to String
{
	...
	final packageNameLocal = 'com.Ethantobot.nightmarevisionmobile';
	final fileLocalONLINE = 'NightmareVisionMobileOnline';
	final fileLocal = 'NightmareVisionMobile';
	final fileLocalNF = 'NightmareVisionMobileNF';
	final fileLocalEX = 'NightmareVisionMobile'; //idk why
	...
	var EXTERNAL_NF = "EXTERNAL_NVM";
	var EXTERNAL_EX = "EXTERNAL_NVM";
	var EXTERNAL_PE = "EXTERNAL_NVM";
